...
#SBATCH -M volta                                                # partition (this is the queue your job will be added to)
...
#bash ./scripts/run_s4l_fixmatch.sh

METHOD='S4L_FIXMATCH'
NET='resnet34'

# main_s4l_fixmatch.py
python3 main_s4l_fixmatch.py --method ${METHOD} --dataset multi --source real --target sketch --net ${NET} --save_check
#python test.py
